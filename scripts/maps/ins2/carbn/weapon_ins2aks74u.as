...
string V_MODEL = "models/ins2fair/wpn/aks/v_aks74u.mdl";
...
uint SLOT       	= 3;
uint POSITION   	= 6;
float RPM_AIR   	= 1.2 * 675; //Rounds per minute in air
...
class weapon_ins2aks74u : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "m16", GetBodygroup(), (61.0/48.0) );
		}
		else
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (136.0/49.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (95.0/49.0), GetBodygroup() );
			canReload = false;
		}
