...
string V_MODEL = "models/ins2fair/wpn/sks/v_sks.mdl";
...
class weapon_ins2sks : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "m16", GetBodygroup(), (100.0/56.0) );
		}
		else
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (141.0/46.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (130.0/48.0), GetBodygroup() );
			canReload = false;
		}
