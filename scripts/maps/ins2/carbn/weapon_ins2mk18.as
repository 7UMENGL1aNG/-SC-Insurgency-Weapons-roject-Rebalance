...
string V_MODEL = "models/ins2fair/wpn/mk18/v_mk18.mdl";
...
class weapon_ins2mk18 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		if( m_WasDrawn == false )
		{
			...
			return Deploy( V_MODEL, P_MODEL, DRAW, "m16", GetBodygroup(), (22.0/43.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (136.0/52.0), SetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (142.0/55.0), SetBodygroup() );
			canReload = false;
		}
