...
string V_MODEL = "models/ins2fair/wpn/g43/v_g43.mdl";
...
uint SLOT       	= 7;
uint POSITION   	= 6;
float RPM_AIR   	= 0.22f / 1.2f; //Rounds per minute in air
...
class weapon_ins2g43 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "sniper", GetBodygroup(), (56.0/48.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "sniper", GetBodygroup(), (38.0/54.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (163.0/48.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (114.0/48.0), GetBodygroup() );
			canReload = false;
		}
