...
string V_MODEL = "models/ins2fair/wpn/m92fs/v_m92fs.mdl";
...
float RPM_WTR   	= 0.25f / 1.2f; //Rounds per minute in water
...
class weapon_ins2beretta : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "onehanded", GetBodygroup(), (38.0/48.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, (self.m_iClip == 0) ? DRAW_EMPTY : DRAW, "onehanded", GetBodygroup(), (15.0/48.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (85.0/48.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (77.0/48.0), GetBodygroup() );
			canReload = false;
		}
