...
string V_MODEL = "models/ins2fair/wpn/usp/v_usp.mdl";
...
class weapon_ins2usp : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "onehanded", GetBodygroup(), (56.0/48.0) );
		}
		else
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (85.0/42.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (83.0/42.0), GetBodygroup() );
			canReload = false;
		}
