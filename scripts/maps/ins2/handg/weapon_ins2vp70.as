...
string V_MODEL = "models/ins2fair/wpn/vp70/v_vp70.mdl";
...
uint SLOT       	= 1;
uint POSITION   	= 11;
float RPM_AIR   	= 1.2 * 1400; //Rounds per minute in air
float RPM_WTR   	= 1.2 * 1150; //Rounds per minute in water
...
class weapon_ins2vp70 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "onehanded", GetBodygroup(), (70.0/48.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "onehanded", GetBodygroup(), (30.0/58.0) );
	}
	...
	void Reload()
	{
		ChangeFireMode( (WeaponADSMode == INS2BASE::IRON_IN) ? IRON_FIRESELECT : FIRESELECT, GetBodygroup(), INS2BASE::SELECTFIRE_SEMI, INS2BASE::SELECTFIRE_3XBURST, (40.0/70.0) );
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (140.0/43.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (92.0/43.0), GetBodygroup() );
			canReload = false;
		}
