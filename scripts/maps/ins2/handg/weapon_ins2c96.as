...
string V_MODEL = "models/ins2fair/wpn/c96/v_c96.mdl";
...
float RPM_WTR   	= 0.3f / 1.2f; //Rounds per minute in water
...
class weapon_ins2c96 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "onehanded", GetBodygroup(), (65.0/48.0) );
		}
		else
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (139.0/49.0), SetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (195.0/56.0), SetBodygroup() );
			canReload = false;
		}
