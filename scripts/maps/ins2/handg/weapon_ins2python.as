...
string V_MODEL = "models/ins2fair/wpn/python/v_python.mdl";
...
uint SLOT       	= 1;
uint POSITION   	= 13;
float RPM_AIR   	= 0.15f / 1.2f; //Rounds per minute in air
...
class weapon_ins2python : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "python", GetBodygroup(), (70.0/48.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "python", GetBodygroup(), (16.0/48.0) );
	}
	...
	void Reload()
	{
		...
		{
			Reload( MAX_CLIP, RELOAD, (136.0/49.0), SetBodygroup() );
			canReload = false;
		}
