...
string V_MODEL = "models/ins2fair/wpn/saiga/v_saiga.mdl";
...
uint SLOT       	= 3;
uint POSITION   	= 15;
float RPM_AIR   	= 1.2 * 350; //Rounds per minute in air
float RPM_WTR   	= 1.2 * 250; //Rounds per minute in water
...
class weapon_ins2saiga12 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "shotgun", GetBodygroup(), (78.0/56.0) );
		}
		else
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (240.0/43.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (175.0/43.0), GetBodygroup() );
			canReload = false;
		}
