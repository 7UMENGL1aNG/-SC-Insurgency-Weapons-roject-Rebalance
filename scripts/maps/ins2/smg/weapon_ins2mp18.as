...
string V_MODEL = "models/ins2fair/wpn/mp18/v_mp18.mdl";
...
float RPM_WTR   	= 1.2 * 325; //Rounds per minute in water
...
class weapon_ins2mp18 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "mp5", GetBodygroup(), (55.0/48.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, (self.m_iClip > 0) ? DRAW : DRAW_EMPTY, "mp5", GetBodygroup(), (25.0/48.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (165.0/50.0), SetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (140.0/50.0), SetBodygroup() );
			canReload = false;
		}
