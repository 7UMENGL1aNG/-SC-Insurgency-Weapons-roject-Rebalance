...
string V_MODEL = "models/ins2fair/wpn/mp40/v_mp40.mdl";
...
class weapon_ins2mp40 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		if( m_WasDrawn == false )
		{
			...
			return Deploy( V_MODEL, P_MODEL, (self.m_iClip > 0) ? DRAW : DRAW_EMPTY, "mp5", GetBodygroup(), (22.0/51.8) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (139.0/50.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (90.0/50.0), GetBodygroup() );
			canReload = false;
		}
