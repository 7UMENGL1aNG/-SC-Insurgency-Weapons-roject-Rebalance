...
string V_MODEL = "models/ins2fair/wpn/l2a3/v_l2a3.mdl";
...
class weapon_ins2l2a3 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "mp5", GetBodygroup(), (80.0/56.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, (self.m_iClip > 0) ? DRAW : DRAW_EMPTY, "mp5", GetBodygroup(), (22.0/48.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (134.0/37.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (97.0/52.0), GetBodygroup() );
			canReload = false;
		}
