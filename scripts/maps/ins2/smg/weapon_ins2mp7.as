...
string V_MODEL = "models/ins2fair/wpn/mp7/v_mp7.mdl";
...
uint SLOT       	= 2;
uint POSITION   	= 13;
float RPM_AIR   	= 1.2 * 950; //Rounds per minute in air
...
class weapon_ins2mp7 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "mp5", GetBodygroup(), (52.0/52.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "mp5", GetBodygroup(), (25.0/48.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (149.0/52.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (95.0/49.0), GetBodygroup() );
			canReload = false;
		}
