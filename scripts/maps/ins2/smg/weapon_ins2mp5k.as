...
string V_MODEL = "models/ins2fair/wpn/mp5k/v_mp5k.mdl";
...
class weapon_ins2mp5k : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "mp5", GetBodygroup(), (35.0/40.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "mp5", GetBodygroup(), (20.0/50.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (135.0/52.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (95.0/52.0), GetBodygroup() );
			canReload = false;
		}
