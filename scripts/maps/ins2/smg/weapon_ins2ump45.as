...
string V_MODEL = "models/ins2fair/wpn/ump45/v_ump45.mdl";
...
float RPM_BURST_AIR	= 1.2 * 850; //Burst fire rate in air
float RPM_BURST_WTR	= 1.2 * 600; //Burst fire rate in water
...
class weapon_ins2ump45 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "mp5", GetBodygroup(), (56.0/56.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "mp5", GetBodygroup(), (15.0/48.0) );
	}
	...
	void Reload()
	{
		ChangeFireMode( (WeaponADSMode == INS2BASE::IRON_IN) ? IRON_FIRESELECT : FIRESELECT, GetBodygroup(), INS2BASE::SELECTFIRE_AUTO, INS2BASE::SELECTFIRE_3XBURST, (25.0/60.0) );
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (137.0/49.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (97.0/49.0), GetBodygroup() );
			canReload = false;
		}
