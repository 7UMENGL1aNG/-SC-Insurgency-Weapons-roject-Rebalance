...
string V_MODEL = "models/ins2fair/wpn/m16a1/v_m16a1.mdl";
...
class weapon_ins2m16a1 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "m16", GetBodygroup(), (82.0/48.0) );
		}
		else
		{
			if( WeaponGLMode == INS2BASE::GL_AIMED )
				return Deploy( V_MODEL, P_MODEL, GL_DRAW, "m16", GetBodygroup(), (28.0/50.0) );
			else
				return Deploy( V_MODEL, P_MODEL, DRAW, "m16", GetBodygroup(), (19.0/48.0) );
		}
	}
	...
	{
		if( WeaponADSMode == INS2BASE::IRON_IN )
			GrenadeLauncherSwitch( GL_IRON_IN, GL_IRON_OUT, GetBodygroup(), (45.0/54.0), (45.0/54.0) );
		else
			GrenadeLauncherSwitch( GL_IN, GL_OUT, GetBodygroup(), (45.0/54.0), (45.0/54.0) );
	}
	...
	void Reload()
	{
		if( WeaponGLMode == INS2BASE::GL_AIMED )
		{
			...
			{
				ReloadSecondary( MAX_CLIP2, GL_RELOAD, (133.0/61.0), GetBodygroup() );
		...
		else
		{
			...
			{
				if( self.m_iClip == 0 )
					Reload( MAX_CLIP, (Math.RandomLong( 0, 1 ) < 0.5) ? RELOAD_EMPTY1 : RELOAD_EMPTY2, (146.0/48.0), GetBodygroup() );
				else
					Reload( MAX_CLIP, RELOAD, (127.0/48.0), GetBodygroup() );
