...
string V_MODEL = "models/ins2fair/wpn/ak74/v_ak74.mdl";
...
class weapon_ins2ak74 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (134.0/42.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (95.0/42.0), GetBodygroup() );
			canReload = false;
		}
