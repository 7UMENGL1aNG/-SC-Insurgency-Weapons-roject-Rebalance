...
string V_MODEL = "models/ins2fair/wpn/m14ebr/v_m14ebr.mdl";
...
uint SLOT       	= 6;
uint POSITION   	= 12;
float RPM_AIR   	= 1.2 * 710; //Rounds per minute in air
...
class weapon_ins2m14ebr : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		if( m_WasDrawn == false )
		{
			...
			return Deploy( V_MODEL, P_MODEL, (self.m_iClip == 0) ? DRAW_EMPTY : DRAW, "sniper", GetBodygroup(), (21.0/50.0) );
	}
