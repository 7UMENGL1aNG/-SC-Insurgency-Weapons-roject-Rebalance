...
string V_MODEL = "models/ins2fair/wpn/g3a3/v_g3a3.mdl";
...
uint SLOT       	= 6;
uint POSITION   	= 10;
float RPM_AIR   	= 1.2 * 550; //Rounds per minute in air
float RPM_WTR   	= 1.2 * 475; //Rounds per minute in water
...
class weapon_ins2g3a3 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "m16", GetBodygroup(), (55.0/48.0) );
		}
		else
	...
	void Reload()
	{
		ChangeFireMode( (WeaponADSMode == INS2BASE::IRON_IN) ? IRON_FIRESELECT : FIRESELECT, GetBodygroup(), INS2BASE::SELECTFIRE_AUTO, INS2BASE::SELECTFIRE_SEMI, (35.0/80.0) );
