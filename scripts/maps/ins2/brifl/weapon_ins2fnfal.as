...
string V_MODEL = "models/ins2fair/wpn/fnfal/v_fnfal.mdl";
...
class weapon_ins2fnfal : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "m16", GetBodygroup(), (54.0/48.0) );
		}
		else
	...
	void Reload()
	{
		ChangeFireMode( (WeaponADSMode == INS2BASE::IRON_IN) ? IRON_FIRESELECT : FIRESELECT, GetBodygroup(), INS2BASE::SELECTFIRE_AUTO, INS2BASE::SELECTFIRE_SEMI, (22.0/60.0) );
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (130.0/42.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (99.0/42.0), GetBodygroup() );
			canReload = false;
		}
