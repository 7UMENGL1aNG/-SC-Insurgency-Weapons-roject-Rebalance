...
string V_MODEL = "models/ins2fair/wpn/law/v_law.mdl";
...
class weapon_ins2law : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase, INS2BASE::ExplosiveBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "rpg", GetBodygroup(), (112.0/56.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "rpg", GetBodygroup(), (32.0/56.0) );
	}
	...
	void Reload()
	{
		...
		{
			Reload( MAX_CLIP, RELOAD, (153.0/63.0), GetBodygroup() );
			SetThink( ThinkFunction( this.EjectClipThink ) );
			self.pev.nextthink = g_Engine.time + (26.0/63.0);
			canReload = false;
		}
