...
string V_MODEL = "models/ins2fair/wpn/rpg7/v_rpg7.mdl";
...
class weapon_ins2rpg7 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase, INS2BASE::ExplosiveBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "rpg", GetBodygroup(), (153.0/64.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, (self.m_iClip == 0) ? DRAW_EMPTY : DRAW, "rpg", GetBodygroup(), (32.0/45.0) );
	}
	...
	void Reload()
	{
		...
		{
			Reload( MAX_CLIP, RELOAD, (156.0/63.0), GetBodygroup() );
			canReload = false;
		}
