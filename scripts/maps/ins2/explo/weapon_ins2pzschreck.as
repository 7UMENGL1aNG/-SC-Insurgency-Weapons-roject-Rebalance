...
string V_MODEL = "models/ins2fair/wpn/schrck/v_schrck.mdl";
...
class weapon_ins2pzschreck : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase, INS2BASE::ExplosiveBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "rpg", GetBodygroup(), (103.0/48.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, (self.m_iClip > 0) ? DRAW : DRAW_EMPTY, "rpg", GetBodygroup(), (42.0/48.0) );
	}
	...
	void Reload()
	{
		...
		{
			Reload( MAX_CLIP, RELOAD, (209.0/59.0), GetBodygroup() );
			canReload = false;
		}
