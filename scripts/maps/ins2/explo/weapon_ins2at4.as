...
string V_MODEL = "models/ins2fair/wpn/at4/v_at4.mdl";
...
class weapon_ins2at4 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase, INS2BASE::ExplosiveBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "rpg", GetBodygroup(), (105.0/50.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, DRAW, "rpg", GetBodygroup(), (29.0/48.0) );
	}
	...
	void Reload()
	{
		...
		{
			Reload( MAX_CLIP, RELOAD, (146.0/54.0), GetBodygroup() );
			SetThink( ThinkFunction( this.EjectClipThink ) );
			self.pev.nextthink = g_Engine.time + (40.0/54.0);
			canReload = false;
		}
